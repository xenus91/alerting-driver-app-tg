...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(
      `Processing complete. Ready to send: ${readyToSend}, Not found phones: ${notFoundPhones.length}, Unverified phones: ${unverifiedPhones.length}, Not found points: ${notFoundPoints.length}`,
    )
    ...
    return NextResponse.json({
      ...
      unverifiedPhones: unverifiedPhones,
