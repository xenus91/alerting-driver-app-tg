...
// import { QuickTripForm } from "@/components/quick-trip-form" // Удаляем импорт QuickTripForm
import { TripSubscriptionButton } from "@/components/trip-subscription-button"
import { useToast } from "@/hooks/use-toast"
import { TripCorrectionModal } from "@/components/trip-correction-modal" // Добавляем импорт TripCorrectionModal
      ...
      <div className="space-y-6 p-4 bg-white border-b sticky top-0 z-10">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button onClick={() => setShowCreateTripModal(true)} className="bg-blue-600 hover:bg-blue-700">
              {" "}
              {/* Изменено здесь */}
